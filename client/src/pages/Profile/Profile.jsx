                ...
                <div className='profile__container'>
                        ...
                        <form action=''>
                            <div className='profile__form-input'>
                                ...
                                <input placeholder='Иванов' type='text' className='profile__form-input-field'
                                       value={secondName} onChange={e => setSecondName(e.target.value)} id='second_name'/>
                            </div>
                            <div className='profile__form-input'>
                                <p className='profile__form-input-text'>Имя*</p>
                                <input placeholder='Иван' type='text' className='profile__form-input-field'
                                       value={firstName} onChange={e => setFirstName(e.target.value)} id='first_name'/>
                            </div>
                            <div className='profile__form-input'>
                                <p className='profile__form-input-text'>Отчество*</p>
                                <input placeholder='Иванович' type='text' className='profile__form-input-field'
                                       value={lastName} onChange={e => setLastName(e.target.value)} id='last_name'/>
                            </div>
                            <div className='profile__form-input'>
                                <p className='profile__form-input-text'>Номер*</p>
                                <input placeholder='+7826754395' type='number' className='profile__form-input-field'
                                       value={telephone} onChange={e => setTelegram(e.target.value)} id='telephone'/>
                            </div>
                            <div className='profile__form-input'>
                                <p className='profile__form-input-text'>E-mail*</p>
                                <input placeholder='pochta@gmail.com' type='email'
                                       className='profile__form-input-field' value={email} onChange={e => setEmail(e.target.value)}
                                       id='email'/>
                            </div>
                            <div className='profile__form-input'>
                                <p className='profile__form-input-text'>Telegram*</p>
                                <input placeholder='https://web.telegram.org/#' type='text'
                                       className='profile__form-input-field' value={telegram} onChange={e => setTelegram(e.target.value)}
                                       id='telegram'/>
                            </div>
                            <p>{status}</p>
                            <button className='profile__form-button' onClick={changeProfileSettings}>Редактировать
                                данные
                            </button>
                        </form>
                    </div>
                    <div className='profile__form2'>
                        ...
                        <div className='profile__buttons-line'>
                            <div className='men__button profile__button' onClick={() => setGender('M')}>
                                Мужской
                            </div>
                            <div className='women__button profile__button' onClick={() => setGender('F')}>
                                Женский
                            </div>
                        </div>
                    </div>
