  ...
  return (
    <main>
      ...
      <section className='popularCours'>
        <h2 className='titleOfPage'>Популярные курсы</h2>
        <div className='row'>
      ...
      <section className='aboutUs'>
        ...
        <div className="aboutUs__container">
          ...
          <div className="aboutUs__text-block text-block_2">
            ...
            <p className="aboutUs__text">дать возможность каждому быть востребованным специалистом прямо сейчас.
            </p>
          </div>
          <div className="aboutUs__text-block text-block_3">
            <p className="aboutUs__text">Большой выбор курсов для профессионального и личностного развития. Здесь каждый сможет найти дело по душе</p>
          </div>
      ...
      <section className='WhatsWeCan'>
        ...
        <div className="WhatsWeCan__line">
          ...
          <div className="WhatsWeCan__block">
            <div className="WhatsWeCan__innerBlock">
              <p className="WhatsWeCan__block-text">Кураторы - признанные профессионалы,  которые помогут в начинаниях</p>
            </div>
          </div>
          <div className="WhatsWeCan__block">
            <div className="WhatsWeCan__innerBlock">
              <p className="WhatsWeCan__block-text">Возможность возвращения к пройденному материалу</p>
            </div>
          </div>
          <div className="WhatsWeCan__block">
            <div className="WhatsWeCan__innerBlock">
