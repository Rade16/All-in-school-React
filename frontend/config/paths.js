...
// single-page apps that may serve menu.html for nested URLs like /todos/42.
...
module.exports = {
  ...
  appHtml: resolveApp('public/menu.html'),
  catalogHtml: resolveApp('public/catalog.html'),
  courseHtml: resolveApp('public/course.html'),
