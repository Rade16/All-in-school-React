# Generated by Django 5.0.2 on 2024-02-19 09:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='lessons.lesson', verbose_name='Урок (Обязательно)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tests.test', verbose_name='Тест (Обязательно)')),
            ],
            options={
                'verbose_name': 'Вопрос',
